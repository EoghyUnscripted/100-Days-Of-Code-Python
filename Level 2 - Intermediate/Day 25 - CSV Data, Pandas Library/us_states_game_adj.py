...
while len(score.correct_guesses) < 50:
    ...
    print(f"Current Score: {len(score.correct_guesses)}/50 Correct")    # Print current guesses
    answer_state = input("Guess the name of a state: ").capitalize()    # Prompt user for a guess
