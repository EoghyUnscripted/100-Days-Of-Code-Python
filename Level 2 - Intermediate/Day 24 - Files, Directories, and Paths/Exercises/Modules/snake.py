...
class Snake:
    ...
    def reset(self):
        """ Function used to reset the snake object for continuous play. """
        for segments in self.turtle_list:
            segments.goto(-1000, 1000) # Move all turtle elements in tail off-screen
        self.turtle_list.clear()    # Remove tail from snake
        self.create_snake() # Create a new snake head
        self.head = self.turtle_list[0]     # Set head attribute for navigation